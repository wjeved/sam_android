    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.headerAreaOn}>
          <Text style={{color:'#1E2022', fontWeight:'bold', fontSize:18, marginTop:8}}>Notification</Text>
        </View>
