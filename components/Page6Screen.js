      ...
      <View style={styles.container}>
        ...
        <View style={styles.content2}>
                ...
                if (sday == item.date) {
                  return(
                    ...
                    <TouchableOpacity onPress={() => _getDataByBtn(item.date)} style={styles.dateItem}>
                            ...
                            <Text style={styles.dateItemText2}>{day}</Text>
                    </TouchableOpacity>
                  ...
                  return(
                    ...
                    <TouchableOpacity onPress={() => _getDataByBtn(item.date)} style={styles.dateItem2}>
                            ...
                            <Text style={styles.dateItemText4}>{day}</Text>
                    </TouchableOpacity>
          ...
          <FlatList 
            ...
            renderItem={({item}) => { 
                ...
                // 반복
                return(
                  <TouchableOpacity onPress={() => navigation.push("InquireDetail", { idx: item.idx2, idx2:item.idx })} style={styles.productItem}>
                    <Image style={styles.tinyLogo} source={{ uri: pfImg }} style={styles.productItemImg} />
                    {item.status == 'Y' ?
        ...
        <View style={styles.bottomMenu}>
          ...
          <TouchableOpacity style={styles.bottomTabBtnOn}
            ...
            <Text style={styles.bottomTabon}>문의내역</Text>
          </TouchableOpacity>
